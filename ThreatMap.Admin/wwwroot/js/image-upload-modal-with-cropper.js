 ...
 */
function imageUploadModal(btnShowModalElement, uploadURL, minImgWidth, minImgHeight, imageBase) {
    //settings
    ...
    //variables
    var imageUploadedElement = $("#img-uploaded");
    var modalElement = $("#modal-upload-image");
    var _btnShowModalElement = $(btnShowModalElement);
    var fileInputElement = $("#input-image-upload");
    var fileUploadBox = $("#file-upload-box");
    var btnUploadSend = $("#btn-upload-send");
    var _imageBase = $(imageBase);
    var fileType = null;
    var cropBoxData;
    var canvasData;
    var cropper;
    var optionsButtons = $('#optionsButtons');
        ...
        btnUploadSend.bind('click', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.isSuccess) {
                        _imageBase.attr('src', data.data);

                        //if (_imageBase.parent().attr('href') !== "") {
                        //  _imageBase.parent().attr('href', data.data);
                        //}
                        modalElement.modal('hide');
                    } else {
                        alert("Nie udaĹo siÄ wysĹaÄ zdjÄcia. OdswieĹź stronÄ i sprĂłbuj ponownie.");
    ...
    $('.cropper-buttons').on('click', function () {
